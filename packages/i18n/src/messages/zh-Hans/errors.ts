...
export const errorsZhHans: ErrorMessages = {
  ...
  'field.shortName.required': 'short_name 不能为空',
  'field.shortName.length': 'short_name 长度需在 {{shortNameMin}}–{{shortNameMax}} 位之间',
  'field.shortName.charset': 'short_name 只能包含小写字母、数字与连字符，且不能以连字符开头或结尾',
